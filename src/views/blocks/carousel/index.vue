...
<template>
  <DocLayout title="Carousel" :sections="SECTIONS" :sub-modules="BLOCKS_SUBMODULES" sub-modules-label="Blocks">
    <article>
      ...
      <Section id="behavior" title="Behaviour">
        ...
        <PropertyCard type="number (min 500)" default-value="4000">
          <strong>Autoplay interval</strong> — milliseconds between slides, stepped in 500ms
          increments.
        </PropertyCard>
        <PropertyCard type="number (min 0)" default-value="400">
      ...
      <Section id="slides-per-view" title="Slides per view">
        <PropertyCard type="number (1–6)" default-value="3">
      ...
      <Section id="appearance" title="Appearance">
        ...
        <PropertyCard type="number (16–80)" default-value="40">
          <strong>Arrow size</strong> — in px.
        </PropertyCard>
        <PropertyCard type="color | null">
          <strong>Dot color</strong> and <strong>Active dot color</strong>
        </PropertyCard>
        <PropertyCard type="number (4–24)" default-value="8">
