...
<template>
  <DocLayout title="Tabs" :sections="SECTIONS" :sub-modules="BLOCKS_SUBMODULES" sub-modules-label="Blocks">
    <article>
      <header class="mb-8 border-b border-slate-200 pb-6">
        <h1 class="mt-1 text-3xl font-bold" style="width: fit-content">Tabs Block</h1>
      ...
      <Section id="orientation" title="Orientation & behaviour">
        <PropertyCard type="'horizontal' | 'vertical'" default-value="vertical">
        ...
        <PropertyCard
          ...
          default-value="showSelectedSection"
        >
      ...
      <Section id="active-tab" title="Active tab">
        ...
        <PropertyCard type="number" default-value="unset">
